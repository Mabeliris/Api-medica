...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DatosReservaConsulta> datosReservaConsultaTest;

    @Autowired
    private JacksonTester<DatosDetalleConsulta> datosDetalleConsultaTest;
    ...
    void reservar_escenario2() throws Exception {
        ...
        when(reservaDeConsultas.reservar(any())).thenReturn(datosDetalle);//mockito

        var response = mockMvc.perform(post("/consultas")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(datosReservaConsultaTest.write(
        ...
        var jsonEsperado = datosDetalleConsultaTest.write(
                datosDetalle
        ).getJson();

...
public class MedicoController {
    ...
    @GetMapping
    public PagedModel<EntityModel<MedicoDto>> listar(@PageableDefault(size = 10, sort = {"nombre"}) Pageable paginacion) {
        Page<MedicoDto> pagina = repository.findAll(paginacion).map(MedicoDto::new);
